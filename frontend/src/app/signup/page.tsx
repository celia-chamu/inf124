...
export default function Signup(){
    return(
        <div className="flex items-center justify-center h-full w-screen mt-30">
            <form className= "h-auto w-auto">
                <h1 className="flex justify-center items-center text-4xl sm:text-5xl p-10 order-8">Create Account</h1>
